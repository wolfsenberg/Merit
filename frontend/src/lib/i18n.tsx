...
export const t: Translations = {
  ...
  "nav.savings": { en: "Savings", tl: "Savings" },
  "nav.history": { en: "History", tl: "History" },
  "nav.wallet": { en: "Wallet", tl: "Wallet" },
  "nav.scholarships": { en: "Scholarships", tl: "Scholarships" },
  "nav.documents": { en: "Documents", tl: "Documents" },
  "nav.alerts": { en: "Alerts", tl: "Alerts" },

  // Dashboard
  "dash.balance": { en: "Available Balance", tl: "Available Balance" },
  "dash.receive": { en: "Receive", tl: "Receive" },
  "dash.cashout": { en: "Cash Out", tl: "Cash Out" },
  "dash.save": { en: "Save", tl: "Save" },
  "dash.active_scholarship": { en: "Active Scholarship", tl: "Active na Scholarship" },
  "dash.recent": { en: "Recent", tl: "Mga Recent" },
  "dash.see_all": { en: "See all", tl: "Tingnan lahat" },
  "dash.scholarship_received": { en: "Scholarship Received", tl: "Na-receive na scholarship" },
  "dash.cashout_to": { en: "Cash Out to GCash", tl: "Na-cash out sa GCash" },
  "dash.saved_to": { en: "Saved to", tl: "Na-save sa" },
  "dash.verified": { en: "Verified", tl: "Verified na" },
  "dash.next_payout": { en: "Next payout", tl: "Susunod na payout" },
  "dash.amount": { en: "Amount", tl: "Amount" },
